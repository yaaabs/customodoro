(function () {
  ...
  function updateProgressCirclePosition() {
    ...
    if (miniProgressCircle && miniProgressBar && window.bgmPlayer) {
      ...
      const miniProgressContainer = document.querySelector(
  ...
  function setupMiniPlayerEvents() {
      ...
      fullSettingsBtn.addEventListener("click", function () {
        ...
        if (settingsModal) {
          ...
          setTimeout(() => {
            ...
            const bgmNavItem = document.querySelector(
              '.settings-nav-item[data-section="bgm"]',
            );
    ...
    if (volumeSlider && volumeDisplay) {
      volumeSlider.addEventListener("input", function () {
        ...
        if (
          window.bgmPlayer &&
          typeof window.bgmPlayer.setVolume === "function"
        ) {
    ...
    if (prevBtn) {
      prevBtn.addEventListener("click", function () {
        if (
          window.bgmPlayer &&
          typeof window.bgmPlayer.previous === "function"
        ) {
    ...
    if (miniProgressContainer) {
      miniProgressContainer.addEventListener("click", function (e) {
        if (
          window.bgmPlayer &&
          typeof window.bgmPlayer.getDuration === "function"
        ) {
  ...
  function updateTrackInfo(
    ...
    artist = "Select a playlist to start",
  ) {
  ...
  function handleViewportChange() {
    if (isOpen) {
      ...
      setTimeout(() => {
        ...
        const miniPlayerContent = document.querySelector(
