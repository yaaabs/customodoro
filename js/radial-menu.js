...
(function () {
  ...
  function positionMenuItemsInCircle() {
    ...
    menuItems.forEach((item, index) => {
      ...
      const angle =
        (startAngle + (angleSpread * index) / (totalItems - 1)) *
        (Math.PI / 180);
  ...
  function setupEventListeners() {
    ...
    document
      .getElementById("radial-fullscreen-btn")
    ...
    document
      .getElementById("radial-focus-btn")
      .addEventListener("click", function () {
        // Call the focus mode toggle
        if (
          typeof focusMode !== "undefined" &&
          typeof focusMode.toggle === "function"
        ) {
          focusMode.toggle();
        } else if (
          window.focusMode &&
          typeof window.focusMode.toggle === "function"
        ) {
    ...
    document
      .getElementById("radial-settings-btn")
      .addEventListener("click", function () {
    ...
    document
      .getElementById("radial-music-btn")
      .addEventListener("click", function () {
        ...
        if (
          ...
          typeof window.miniMusicPlayer.open === "function"
        ) {
    ...
    document
      .getElementById("radial-cache-btn")
      .addEventListener("click", function () {
        // Call the cache manager function to clear cache and reload
        if (
          window.cacheManager &&
          typeof window.cacheManager.clearCacheAndReload === "function"
        ) {
