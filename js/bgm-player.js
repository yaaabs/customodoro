(function () {
  ...
  function init() {
    ...
    playlists = {
      ...
      "deep-focus": [
        {
          title: "Clear Skies",
          artist: "Aqua Scholar",
          src: "audio/BGM/Deep_Focus_Study_Playlist/Clear Skies - Aqua Scholar.mp3",
        },
        {
          title: "Gentle Ocean",
          artist: "Sonic Strokes, Nahh Chill, Aqua Scholar",
          src: "audio/BGM/Deep_Focus_Study_Playlist/Gentle Ocean - Sonic Strokes.mp3",
        },
        {
          title: "Venusian Vespers",
          artist: "Nahh Chill, Aqua Scholar",
          src: "audio/BGM/Deep_Focus_Study_Playlist/Venusian Vespers.mp3",
        },
      ],
      "ambient-long": [
        {
      ...
      "happy-jazz": [
        {
          title: "Happy Swing Jazz Piano",
          artist: "Daily Piano Music Youtube",
          src: "audio/BGM/Happy Swing Jazz Piano.mp3",
        },
      ],
      ...
      "gamma-waves": [
        {
          title: "Headspace",
          artist: "Intense Focus",
          src: "audio/BGM/Gamma_Waves/Headspace.mp3",
        },
        {
          title: "Awakened Mind",
          artist: "Gamma Waves",
          src: "audio/BGM/Gamma_Waves/Awakened Mind.mp3",
        },
        {
          title: "40 Hz Brain Waves",
          artist: "40 Hz Gamma",
          src: "audio/BGM/Gamma_Waves/40 Hz Brain Waves.mp3",
        },
        {
          title: "12 Hz High Level Cognition",
          artist: "Alpha Waves",
          src: "audio/BGM/Gamma_Waves/12 Hz High Level Cognition.mp3",
        },
        {
          title: "Brain Waves",
          artist: "Brain Waves",
          src: "audio/BGM/Gamma_Waves/Brain Waves.mp3",
        },

        {
          title: "Brain Boost",
          artist: "Theta Waves",
          src: "audio/BGM/Gamma_Waves/Brain Boost.mp3",
        },
        {
          title: "Mind Hack",
          artist: "Intense Focus",
          src: "audio/BGM/Gamma_Waves/Mind Hack.mp3",
        },
        {
          title: "Active Recall",
          artist: "Memorization",
          src: "audio/BGM/Gamma_Waves/Active Recall.mp3",
        },
        {
          title: "Neural Spark",
          artist: "Gamma Waves",
          src: "audio/BGM/Gamma_Waves/Neural Spark.mp3",
        },
        {
          title: "Mind Enhancement",
          artist: "Brain Waves",
          src: "audio/BGM/Gamma_Waves/Mind Enhancement.mp3",
        },

        {
          title: "Deep Working",
          artist: "Clarity",
          src: "audio/BGM/Gamma_Waves/Deep Working.mp3",
        },
        {
          title: "Calm Brain",
          artist: "Theta Waves",
          src: "audio/BGM/Gamma_Waves/Calm Brain.mp3",
        },
        {
          title: "40 Hz Creativity",
          artist: "40 Hz Gamma",
          src: "audio/BGM/Gamma_Waves/40 Hz Creativity.mp3",
        },
        {
          title: "12 Hz Problem Solving",
          artist: "Alpha Waves",
          src: "audio/BGM/Gamma_Waves/12 Hz Problem Solving.mp3",
        },
        {
          title: "Clear Mind",
          artist: "Deep Work",
          src: "audio/BGM/Gamma_Waves/Clear Mind.mp3",
        },

        {
          title: "Mind Fuel",
          artist: "Hyper Focus",
          src: "audio/BGM/Gamma_Waves/Mind Fuel.mp3",
        },
        {
          title: "Brain Power",
          artist: "Brain Power",
          src: "audio/BGM/Gamma_Waves/Brain Power.mp3",
        },
        {
          title: "Memorization",
          artist: "Memorization",
          src: "audio/BGM/Gamma_Waves/Memorization.mp3",
        },
      ],
    };
  ...
  function setupEventListeners() {
    ...
    audio.addEventListener("play", function () {
      ...
      if (
        ...
        typeof window.miniMusicPlayer.sync === "function"
      ) {
  ...
  function loadTrack(index, userInitiated = false) {
    ...
    if (!playbackList || index < 0 || index >= playbackList.length) {
      if (trackTitleElement)
        trackTitleElement.textContent = "Select a playlist";
  ...
  function getCurrentPlaybackTrack() {
    ...
    if (
      !playbackList ||
      currentTrackIndex < 0 ||
      currentTrackIndex >= playbackList.length
    )
      return null;
  ...
  function play() {
    if (!isBGMEnabled || !currentPlaylist || currentPlaylist.length === 0)
      return;
  ...
  function updateActiveTrack() {
    ...
    trackItems.forEach((item, idx) => {
      ...
      const isPlayingNow =
        isActive && window.bgmPlayer && window.bgmPlayer.isPlaying();
  ...
  (function () {
    ...
    function getBgmAlbumArtPath() {
      if (
        !window.bgmPlayer ||
        typeof window.bgmPlayer.getCurrentTrack !== "function"
      ) {
        return null;
      }
