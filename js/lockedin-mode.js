...
(function () {
  ...
  function initLockedInMode() {
    ...
    if (
      localStorage.getItem("lockedInModeEnabled") === null &&
      ...
      isLockedInModeEnabled =
        localStorage.getItem("lockedInModeEnabled") !== "false";
    } else if (localStorage.getItem("focusModeEnabled") !== null) {
      isLockedInModeEnabled =
        localStorage.getItem("focusModeEnabled") !== "false";
  ...
  function activateLockedInMode() {
    ...
    const lockedInModeProgress = document.querySelector(
    ...
    const lockedInModeSession = document.getElementById(
  ...
  window.focusMode = {
    ...
    setEnabled: forwardToNewFunctions(
      setLockedInModeEnabled,
      setLockedInModeEnabled,
    ),
    setup: forwardToNewFunctions(
      setupLockedInModeToggle,
      setupLockedInModeToggle,
    ),
  };
