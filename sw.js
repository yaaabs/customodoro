const CACHE_NAME = "customodoro-static-v7.1.4"; // Bump to v7.1.5 
const ASSETS_CACHE = "customodoro-assets-v6.1.5 "; // Bump to v6.1.5 
const urlsToCache = [
...
self.addEventListener("install", (event) => {
  console.log('🔧 Service Worker v7.1.5 installing...');
...
self.addEventListener("activate", (event) => {
  console.log('🚀 Service Worker v7.1.5 activating...');
