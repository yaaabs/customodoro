const CACHE_NAME = "customodoro-static-v7.2.7 "; // Bump to v7.2.7  
const ASSETS_CACHE = "customodoro-assets-v6.1.6 "; // Bump to v6.1.6 
const urlsToCache = [
...
self.addEventListener("install", (event) => {
  console.log('🔧 Service Worker v7.2.7  installing...');
...
self.addEventListener("activate", (event) => {
  console.log('🚀 Service Worker v7.2.7  activating...');
