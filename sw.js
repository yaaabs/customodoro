const CACHE_NAME = "customodoro-static-v7.1.1"; // Bump to v7.1.1 
const ASSETS_CACHE = "customodoro-assets-v6.1.1"; // Bump to v6.1.1 
const urlsToCache = [
...
self.addEventListener("install", (event) => {
  console.log('🔧 Service Worker v7.1.1 installing...');
...
self.addEventListener("activate", (event) => {
  console.log('🚀 Service Worker v7.1.1 activating...');
