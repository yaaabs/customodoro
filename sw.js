const CACHE_NAME = "customodoro-static-v6.7.9"; // Bump to v6.7.9
const ASSETS_CACHE = "customodoro-assets-v3"; // Bump to v2
const urlsToCache = [
...
self.addEventListener("install", (event) => {
  console.log('🔧 Service Worker v6.7.9 installing...');
...
self.addEventListener("activate", (event) => {
  console.log('🚀 Service Worker v6.7.9 activating...');
