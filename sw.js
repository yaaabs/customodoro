const CACHE_NAME = "customodoro-static-v7.4.1"; // Bump to v7.4.1  
const ASSETS_CACHE = "customodoro-assets-v6.2.1"; // Bump to v6.2.1 
const urlsToCache = [
  // ═══════════════════════════════════════════════════════════════════
  // HTML Pages
  // ═══════════════════════════════════════════════════════════════════
...
self.addEventListener("install", (event) => {
  console.log('🔧 Service Worker v7.4.1 installing...');
...
self.addEventListener("activate", (event) => {
  console.log('🚀 Service Worker v7.4.1 activating...');
