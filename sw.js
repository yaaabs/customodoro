const CACHE_NAME = "customodoro-static-v6.7.10"; // Bump to v6.7.10
const ASSETS_CACHE = "customodoro-assets-v4"; // Bump to v4
const urlsToCache = [
...
self.addEventListener("install", (event) => {
  console.log('🔧 Service Worker v6.7.10 installing...');
...
self.addEventListener("activate", (event) => {
  console.log('🚀 Service Worker v6.7.10 activating...');
